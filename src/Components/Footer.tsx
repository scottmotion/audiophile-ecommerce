  ...
  return (
    <>
      <footer className="flex w-full flex-row items-center justify-center bg-darkest-grey px-6 md:px-10">
        <div className="max-w-content grid justify-items-center gap-12 pb-10 pt-[3.25rem] md:grid-cols-2 md:justify-items-start md:gap-8 md:pb-[2.875rem] md:pt-[3.75rem] lg:gap-9 lg:pb-12 lg:pt-[4.75rem]">
          <Link to={"/"}>
