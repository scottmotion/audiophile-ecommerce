  ...
  return (
    <>
      ...
      <div
        ...
        className="absolute left-1/2 top-1/2 z-40 flex max-h-[calc(100vh-8rem)] w-full max-w-[calc(100vw-3rem)] -translate-x-1/2 -translate-y-1/2 flex-col justify-start gap-3 overflow-y-auto rounded-lg bg-white p-8 md:max-w-[23.5rem]"
      >
        <ConfirmationIcon />
